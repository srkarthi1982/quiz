...
- 2026-02-22 FAQ content refresh (production): replaced placeholder/demo FAQ entries with real Quiz user FAQs (5) via `db/seed-faq-content.ts` using audience=`user`, published entries, and stable sort order; aligned content with current Quiz V1 behavior and ecosystem FAQ contract.
