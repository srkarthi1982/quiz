...
class Countries extends StoreBase {
    constructor() {
        super('public', 'Countries', 'Country', 'countries', 'countries', item, filters, sorting, fields, columns);
    }
    onInit(location) {
...
Alpine.store('countries', new Countries());